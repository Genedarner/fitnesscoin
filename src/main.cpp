...
int nCoinbaseMaturity = 30; //20 blocks for coins to mature
...
const string strMessageMagic = "fitnesscoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 20000000 * COIN; // ICO Premine
    }
		    else if(pindexBest->nHeight+1 <= 25000)
    {
        nSubsidy = 10 * COIN; // Low Reward for Fair Launch
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fitnesscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "fitnesscoin, a safe and decentralised ledger, 2018";
        CTransaction txNew;
        txNew.nTime = 1522322700;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3033a1fdc0af83adfd560dbed221b92a321ec064c2a5ade368eb079810ea561c"));
        block.print();
